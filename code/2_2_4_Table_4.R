#===============================================================================
# Table 4: Statistics about business functions
#===============================================================================
...
names(xt) <- c("Business function", "$H_{HS}$", "$H_{RD}$", "$\\frac{M}{W}$", "$\\frac{K}{W}$",  "$\\frac{K_{inc}}{K}$")
...
print(xtable(xt, 
             ...
             display = c("s", "s","fg","fg", "fg", "fg", "fg"), digits = 3),
              ...
              add.to.row = list(pos=list(-1,8), command=c("\\toprule \n", "\\bottomrule \n \\multicolumn{6}{@{}p{0.7\\linewidth}@{}}{\\scriptsize \\emph{Notes:} This table displays summary statistics of factor contents of business functions. $H_{HS}$ and $H_{RD}$ are the share of hours worked by high-skilled and R\\&D workers, respectively. $K_{corp}$ and $K_{inc}$ are the stock of physical and intangible capital, respectively. $M$ is the amount of materials purchases. $RD$ is the wage bill of R\\&D workers. $W$ is the total wage bill.} \\\\ \n")))
