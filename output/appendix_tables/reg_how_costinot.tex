...
\bottomrule \multicolumn{7}{@{}p{\linewidth}@{}}{\footnotesize \emph{Notes:} This table reports average marginal effects of the logit estimation of the same model as in \cite{costinot_2011}. We include one observation per firm $\times $ business function. \sym{*} \(p<0.10\) \sym{**} \(p<0.05\) \sym{***} \(p<0.01\)} \end{tabular}\end{table}
